...
import static com.example.qexamworld.DbQuery.loadquestions;
...
public class StartTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadquestions(new MyCompleteListener() {
            ...
            public void onFailure() {
                Toast.makeText(StartTestActivity.this, "Something went worng ! Please Try Again", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void setData(){
        catName.setText(catelist.get(DbQuery.g_selected_test_index).getName());
        ...
        bestScore.setText(String.valueOf(DbQuery.testList.get(DbQuery.g_selected_test_index).getTopScore()));
        time.setText(String.valueOf(DbQuery.testList.get(DbQuery.g_selected_test_index).getTime()));
    }
}